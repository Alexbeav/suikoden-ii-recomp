...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Suikoden II",
    .project_root_env = "SUIKODEN_II_PROJECT_ROOT",
    .build_dir_env = "SUIKODEN_II_BUILD_DIR",
    .force_setup_env = "SUIKODEN_II_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_009.58_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Suikoden_II",
    .prepare_note =
